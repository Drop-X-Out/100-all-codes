...
Now in the `Home.jsx` page in the pages directory, we will import these components to have a functional Landing Page
...
1. Let us know setup the `ChatHome` page and create the necessary components for it.
...
Inside the `Chat` directory inside the `components` directory, create the following components by copy pasting it. 
...
This is how the final output of `ChatHome` would look like:

![Untitled](https://talktohire.blr1.digitaloceanspaces.com/Untitled_4.png)

1. Now we will create the final components that is the Profile and Select-Avatar components. Open the following files and copy paste the entire code.
...
Above Image is the output of what should the Profile window look like , but we still don’t have the Avatar Images yet. 

- We need to post the data in DB using any of the API platforms like Postman or Thunder Client. To use Thunder Client , Search for Thunder Client in the Extensions Marketplace in `VScode`.

![Untitled](https://talktohire.blr1.digitaloceanspaces.com/Untitled_6.png)

- Now select Thunder Client from the “Addition Views” option in sidebar.

![Untitled](https://talktohire.blr1.digitaloceanspaces.com/Untitled_7.png)

- This will open a new Thunder Client Window, click on the “New Request” button to open the window. Here we can perform API request and checkout any response coming from the server.

![Untitled](https://talktohire.blr1.digitaloceanspaces.com/Untitled_8.png)

- We will now perform the API request to avatar route with the link of the image to have it as an avatar.

![Untitled](https://talktohire.blr1.digitaloceanspaces.com/Untitled_9.png)

We can use any image you want for Avatars, her are some sample image links which you can post to your DB via API request.

- [https://i.imgur.com/qGsYvAK.png](https://i.imgur.com/qGsYvAK.png)
- [https://i.imgur.com/2yxwOt6.png](https://i.imgur.com/2yxwOt6.png)
- [https://i.imgur.com/fzB1ZPT.png](https://i.imgur.com/fzB1ZPT.png)
- [https://i.imgur.com/IZYdi6A.png](https://i.imgur.com/IZYdi6A.png)
- [https://i.imgur.com/EBX70zu.png](https://i.imgur.com/EBX70zu.png)
- [https://i.imgur.com/rUwDBuq.png](https://i.imgur.com/rUwDBuq.png)

We can now see the avatars in the profile tab after seeding the Database with the above links. Now we can select any avatar which will be displayed to any other user on his Chat-Home when he will see out profile.

Final Step is to build the application . Run the following command inside the frontend directory to have a production build.

```bash
npm run build
```

Our Chat Application is now ready which can deployed to production.