...
- Add the stripe into the landing page in the pricing section. Add the following code in the **/app/page.js**
...
- Finally add the final code in the **/components/landingpage/index.js:**
...
export default function LandingPage({ user, products, subscription }) {
...
Your application should be running with authentication and payments. 
